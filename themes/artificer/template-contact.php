...
if( isset( $_POST['submitted'] ) ) {
	...
	if( trim( $_POST['checking'] ) !== '' ) {
		...
		if( ! isset( $hasError ) ) {
			 ...
			 $emailTo = "info@anyimpex.com";
			 $fromname = "Admin";
			 //send to customers's  enquiry mail
			...
			if( $sendCopy == true ) {
				...
				$headers = __( 'From: ', 'woothemes' ) . "$fromname <$emailTo>";
				wp_mail( $fromEmail, $subject, $body, $headers );
			}
            ...
            <?php } else { ?>
                ...
                <?php while ( have_posts() ) { the_post(); ?>
					...
					<div class="info"><?php /* ----addeddddddddddddddddddd----*/?>
                            ...
                            <h4>Office :</h4>
                            <div class="con-boxbg">310,sector-10,<br>
                            Gurugram—Haryana-india,
                            <br>Pin Code-122002
                            </div>
                            
                            <h4>Phones :</h4>
                            <div class="con-boxbg">+91 87088 01515<br>
                            +91 94160 64489</div>
                            
                            <h4>Emails :</h4>
                            <div class="con-boxbg link01"><a href="mailto:sales@anyimpex.com" class="link01">sales@anyimpex.com</a><br>
                            <a href="mailto:info@anyimpex.com" class="link01">info@anyimpex.com</a><br>
                            <a href="mailto:exports@anyimpex.com" class="link01">exports@anyimpex.com</a></div>
                             <h4>Our Units :</h4>
                            <div class="con-boxbg">
                                Jaipur-2
                                <br>
