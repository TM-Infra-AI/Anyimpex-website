...
class Woo_AdWidget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct('woo_ad_widget', __('Woo - Adspace Widget', 'woothemes'), $widget_ops);
    }
...
// Register the widget
function register_woo_ad_widget() {
    register_widget('Woo_AdWidget');
}
add_action('widgets_init', 'register_woo_ad_widget');
