...
class Woo_BlogAuthorInfo extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct( 'woo_blog_author_info', __( 'Woo - Blog Author Info', 'woothemes' ), $widget_ops );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ( $page == "home" && is_home() ) || ( $page == "single" && is_single() ) || $page == "all" ) {
            ...
            ?>
            <span class="<?php echo esc_attr( $avatar_align ); ?>"><?php if ( $custom_email ) echo get_avatar( $custom_email, $avatar_size ); ?></span>
     ...
     */
    public function woo_get_settings() {
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <select name="<?php echo $this->get_field_name('avatar_align'); ?>" class="widefat" id="<?php echo $this->get_field_id('avatar_align'); ?>">
                <option value="left" <?php selected( $avatar_align, 'left' ); ?>><?php _e('Left', 'woothemes'); ?></option>
                <option value="right" <?php selected( $avatar_align, 'right' ); ?>><?php _e('Right', 'woothemes'); ?></option>
            </select>
        </p>
        <p>
...
// Register the widget
function register_woo_blog_author_info_widget() {
    register_widget('Woo_BlogAuthorInfo');
}
add_action('widgets_init', 'register_woo_blog_author_info_widget');
