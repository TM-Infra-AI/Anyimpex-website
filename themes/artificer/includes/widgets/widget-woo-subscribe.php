...
class Woo_Subscribe extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct('woo_subscribe', __('Woo - Subscribe / Connect', 'woothemes'), $widget_ops);
    }
    ...
    function form($instance) {
        ...
        <p>
            <input id="<?php echo $this->get_field_id('form'); ?>" name="<?php echo $this->get_field_name('form'); ?>" type="checkbox" <?php checked($form, 'on'); ?> /> <?php _e('Disable Subscription Form', 'woothemes'); ?>
        </p>
        <p>
            <input id="<?php echo $this->get_field_id('social'); ?>" name="<?php echo $this->get_field_name('social'); ?>" type="checkbox" <?php checked($social, 'on'); ?> /> <?php _e('Disable Social Icons', 'woothemes'); ?>
        </p>
        <p>
            <input id="<?php echo $this->get_field_id('single'); ?>" name="<?php echo $this->get_field_name('single'); ?>" type="checkbox" <?php checked($single, 'on'); ?> /> <?php _e('Disable in Posts', 'woothemes'); ?>
        </p>
        <p>
            <input id="<?php echo $this->get_field_id('page'); ?>" name="<?php echo $this->get_field_name('page'); ?>" type="checkbox" <?php checked($page, 'on'); ?> /> <?php _e('Disable in Pages', 'woothemes'); ?>
        </p>
        <?php
    }
}
