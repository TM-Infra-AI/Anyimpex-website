...
class Woo_EmbedWidget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct('woo_embed_widget', __('Woo - Embed/Video', 'woothemes'), $widget_ops);
    }
    ...
    function form($instance) {
        ...
        <p>
            ...
            <select name="<?php echo $this->get_field_name('cat_id'); ?>" class="widefat" id="<?php echo $this->get_field_id('cat_id'); ?>">
                ...
                foreach ($cats as $cat) {
                    ?>
                    <option value="<?php echo absint($cat->cat_ID); ?>" <?php selected($cat->cat_ID, $cat_id); ?>><?php echo esc_html($cat->cat_name . ' (' . $cat->category_count . ')'); ?></option>
                    <?php
                }
                ?>
            </select>
