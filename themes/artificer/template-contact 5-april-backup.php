...
if( isset( $_POST['submitted'] ) ) {
	...
	if( trim( $_POST['checking'] ) !== '' ) {
		...
		$fromEmail = "vinod@marketingmindz.in";
		...
		if( ! isset( $hasError ) ) {
			...
			$headers = __( 'From: ', 'woothemes') . "$name <$fromEmail>" . "\r\n" . __( 'Reply-To: ', 'woothemes' ) . $email;
...
//-->!]]>
    ...
    <div id="content" class="col-full">
		...
		<section id="main" class="fullwidth">
            ...
            <article id="contact-page" class="page type-page con-main-page" >
            ...
            <?php } else { ?>
                ...
                <?php while ( have_posts() ) { the_post(); ?>
					...
					<div class="info"><?php /* ----addeddddddddddddddddddd----*/?>
                            ...
                            <h4>Office :</h4>
                            <div class="con-boxbg">308,SP/1, RIICO IND. AREA,<br>
                            BEHIND ICD MANSAROVER,<br>
                            SANAGER -Jaipur, Rajasthan , India</div>
                            
                            <h4>Phones :</h4>
                            <div class="con-boxbg">0091-1282-276535 (Office)<br>
                            0091-1282-276489 (Fax)</div>
                            
                            <h4>Emails :</h4>
                            <div class="con-boxbg link01"><a href="mailto:sales@ishaexports.com" class="link01">sales@ishaexports.com</a><br>
                            <a href="mailto:info@ishaexports.com" class="link01">info@ishaexports.com</a><br>
                            <a href="mailto:exports@ishaexports.com" class="link01">exports@ishaexports.com</a></div>
                     </div>  
                     <div class="contact_form">   <?php /* -------for contact form------------ */ ?>   
